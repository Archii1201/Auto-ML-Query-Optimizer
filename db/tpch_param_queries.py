...
PARAMS: dict[str, list[dict[str, str | int | float]]] = {
    "q01": [{"DELTA": d} for d in
            (60, 75, 90, 105, 120, 65, 70, 80, 95, 110)],
    "q02": [
        ...
        {"SIZE": 5,  "TYPE": "NICKEL", "REGION": "AFRICA"},
        {"SIZE": 10, "TYPE": "TIN",    "REGION": "ASIA"},
        {"SIZE": 20, "TYPE": "BRASS",  "REGION": "AMERICA"},
        {"SIZE": 30, "TYPE": "STEEL",  "REGION": "EUROPE"},
        {"SIZE": 40, "TYPE": "COPPER", "REGION": "MIDDLE EAST"},
    ],
    "q03": [
        ...
        {"SEGMENT": "AUTOMOBILE", "DATE": "1995-03-01"},
        {"SEGMENT": "BUILDING",   "DATE": "1995-03-25"},
        {"SEGMENT": "FURNITURE",  "DATE": "1995-04-05"},
        {"SEGMENT": "HOUSEHOLD",  "DATE": "1995-02-15"},
        {"SEGMENT": "MACHINERY",  "DATE": "1995-03-10"},
    ],
    "q04": [
        {"DATE": "1993-07-01"},
        {"DATE": "1994-01-01"},
    ...
    "q05": [
        ...
        {"REGION": "AFRICA",      "DATE": "1995-01-01"},
        {"REGION": "AMERICA",     "DATE": "1996-01-01"},
        {"REGION": "ASIA",        "DATE": "1993-01-01"},
        {"REGION": "EUROPE",      "DATE": "1994-01-01"},
        {"REGION": "MIDDLE EAST", "DATE": "1995-01-01"},
    ],
    "q06": [
        ...
        {"DATE": "1993-01-01", "DISCOUNT": 0.04, "QUANTITY": 23},
        {"DATE": "1994-01-01", "DISCOUNT": 0.05, "QUANTITY": 26},
        {"DATE": "1995-01-01", "DISCOUNT": 0.06, "QUANTITY": 23},
        {"DATE": "1996-01-01", "DISCOUNT": 0.07, "QUANTITY": 26},
        {"DATE": "1997-01-01", "DISCOUNT": 0.08, "QUANTITY": 24},
    ],
    "q07": [
        ...
        {"NATION1": "JAPAN",   "NATION2": "INDIA"},
        {"NATION1": "CANADA",  "NATION2": "UNITED STATES"},
        {"NATION1": "ARGENTINA", "NATION2": "BRAZIL"},
        {"NATION1": "VIETNAM", "NATION2": "CHINA"},
    ],
    "q08": [
        ...
        {"NATION": "PERU",        "REGION": "AMERICA", "TYPE": "ECONOMY ANODIZED STEEL"},
        {"NATION": "ARGENTINA",   "REGION": "AMERICA", "TYPE": "PROMO BURNISHED COPPER"},
        {"NATION": "CHINA",       "REGION": "ASIA",    "TYPE": "MEDIUM ANODIZED BRASS"},
        {"NATION": "GERMANY",     "REGION": "EUROPE",  "TYPE": "STANDARD POLISHED TIN"},
        {"NATION": "EGYPT",       "REGION": "MIDDLE EAST", "TYPE": "SMALL PLATED STEEL"},
    ],
    "q09": [{"COLOR": c} for c in (
    ...
    "q11": [
        ...
        {"NATION": "CHINA",   "FRACTION": 0.0001},
        {"NATION": "CANADA",  "FRACTION": 0.0001},
        {"NATION": "BRAZIL",  "FRACTION": 0.0001},
        {"NATION": "ARGENTINA", "FRACTION": 0.0001},
        {"NATION": "EGYPT",   "FRACTION": 0.0001},
    ],
    "q12": [
        ...
        {"SHIPMODE1": "REG AIR","SHIPMODE2": "AIR",  "DATE": "1993-01-01"},
        {"SHIPMODE1": "SHIP",  "SHIPMODE2": "RAIL",  "DATE": "1994-01-01"},
        {"SHIPMODE1": "MAIL",  "SHIPMODE2": "TRUCK", "DATE": "1995-01-01"},
        {"SHIPMODE1": "FOB",   "SHIPMODE2": "SHIP",  "DATE": "1996-01-01"},
        {"SHIPMODE1": "AIR",   "SHIPMODE2": "RAIL",  "DATE": "1997-01-01"},
    ],
    "q13": [
        ...
        {"WORD1": "final",   "WORD2": "requests"},
        {"WORD1": "quick",   "WORD2": "deposits"},
        {"WORD1": "careful", "WORD2": "packages"},
        {"WORD1": "silent",  "WORD2": "accounts"},
        {"WORD1": "busy",    "WORD2": "requests"},
    ],
    "q14": [
        {"DATE": "1993-09-01"},
        {"DATE": "1994-09-01"},
    ...
    "q16": [
        ...
        {"BRAND": "Brand#11", "TYPE": "PROMO ANODIZED",
         "SIZES": "3, 9, 15, 21, 27, 33, 39, 45"},
        {"BRAND": "Brand#21", "TYPE": "MEDIUM BURNISHED",
         "SIZES": "5, 10, 15, 20, 25, 30, 35, 40"},
        {"BRAND": "Brand#31", "TYPE": "SMALL POLISHED",
         "SIZES": "2, 6, 10, 14, 18, 22, 26, 30"},
        {"BRAND": "Brand#51", "TYPE": "LARGE PLATED",
         "SIZES": "7, 14, 21, 28, 35, 42, 49, 50"},
        {"BRAND": "Brand#13", "TYPE": "STANDARD ANODIZED",
         "SIZES": "1, 8, 16, 24, 32, 40, 48, 50"},
    ],
    "q17": [
        ...
        {"BRAND": "Brand#13", "CONTAINER": "JUMBO PKG"},
        {"BRAND": "Brand#21", "CONTAINER": "WRAP CASE"},
        {"BRAND": "Brand#33", "CONTAINER": "MED BAG"},
        {"BRAND": "Brand#44", "CONTAINER": "SM BOX"},
        {"BRAND": "Brand#52", "CONTAINER": "LG DRUM"},
    ],
    "q18": [{"QUANTITY": q} for q in
            (300, 305, 310, 312, 315, 302, 308, 311, 313, 314)],
    "q19": [
        ...
        {"BRAND1": "Brand#24", "BRAND2": "Brand#33", "BRAND3": "Brand#44",
         "Q1": 9,  "Q2": 19, "Q3": 29},
        {"BRAND1": "Brand#13", "BRAND2": "Brand#24", "BRAND3": "Brand#43",
         "Q1": 2,  "Q2": 11, "Q3": 21},
        {"BRAND1": "Brand#11", "BRAND2": "Brand#22", "BRAND3": "Brand#33",
         "Q1": 4,  "Q2": 14, "Q3": 24},
        {"BRAND1": "Brand#14", "BRAND2": "Brand#26", "BRAND3": "Brand#36",
         "Q1": 6,  "Q2": 16, "Q3": 26},
        {"BRAND1": "Brand#19", "BRAND2": "Brand#29", "BRAND3": "Brand#39",
         "Q1": 8,  "Q2": 18, "Q3": 28},
        {"BRAND1": "Brand#25", "BRAND2": "Brand#35", "BRAND3": "Brand#45",
         "Q1": 10, "Q2": 20, "Q3": 30},
    ],
    "q20": [
        ...
        {"COLOR": "green",  "DATE": "1994-01-01", "NATION": "VIETNAM"},
        {"COLOR": "blue",   "DATE": "1995-01-01", "NATION": "CHINA"},
        {"COLOR": "red",    "DATE": "1996-01-01", "NATION": "INDIA"},
        {"COLOR": "yellow", "DATE": "1997-01-01", "NATION": "BRAZIL"},
        {"COLOR": "white",  "DATE": "1994-01-01", "NATION": "ARGENTINA"},
    ],
    "q21": [{"NATION": n} for n in (
        "SAUDI ARABIA", "EGYPT", "JORDAN", "IRAN", "IRAQ",
        "MOROCCO", "ALGERIA", "KENYA", "ETHIOPIA", "MOZAMBIQUE",
    )],
    "q22": [
        {"CCS": "'13','31','23','29','30','18','17'"},
        {"CCS": "'10','11','12','13','14','15','16'"},
        {"CCS": "'20','21','22','23','24','25','26'"},
        {"CCS": "'30','31','32','33','34','25','26'"},
        {"CCS": "'17','19','22','25','28','31','33'"},
        {"CCS": "'11','13','15','17','19','21','23'"},
        {"CCS": "'24','26','28','30','32','34','12'"},
        {"CCS": "'10','15','20','25','30','12','18'"},
        {"CCS": "'13','14','15','16','17','18','19'"},
        {"CCS": "'21','23','25','27','29','31','33'"},
    ],
}
